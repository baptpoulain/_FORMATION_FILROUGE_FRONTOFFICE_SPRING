...
public class PlanningDto {
    ...
    public PlanningDto(int planningId, String planningTitle, String planningDescription, Date planningCreatedAt, Collection<EventsEntity> events) {
        ...
        this.eventsByPlanningId = events.stream()
